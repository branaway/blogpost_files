...
// - end of implicit fields with Play 
	...
	private s.Product product;
	public cn.bran.japid.template.RenderResult render(s.Product product) {
...
"<div class=\"product\">\n" + 
"	<img src=\"");// line 1
p(product.getName());// line 4
p(".jpg\" />\n" + 
"	<span class=\"productname\">");// line 4
p(product.getName());// line 5
p("</span>, <span class=\"price\">$");// line 5
p(product.getPrice());// line 5
p("</span>\n" + 
"</div>\n");// line 5
